...
<div class="container text-center">
  <div class="row">
    ...
    <div class="col">
        <img src="{{asset('img/padi.jpg')}}" class="w-100 rounded-top" alt="">
        <a href="{{ route('list-hama') }}" class="btn btn-success w-100 rounded-0 rounded-bottom">Hama dan Penyakit Padi</a>
